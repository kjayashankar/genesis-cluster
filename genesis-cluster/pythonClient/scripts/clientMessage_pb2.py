...
_RESPONSEMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='no_of_chunks', full_name='ResponseMessage.no_of_chunks', index=4,
      number=15, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='status_msg', full_name='ResponseMessage.status_msg', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='failure', full_name='ResponseMessage.failure', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data', full_name='ResponseMessage.data', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='chunkInfo', full_name='ResponseMessage.chunkInfo', index=8,
