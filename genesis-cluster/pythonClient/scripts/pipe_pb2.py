...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='pipe.proto',
  package='',
  serialized_pb=_b('\n\npipe.proto\x1a\x0c\x63ommon.proto\x1a\x13\x63lientMessage.proto\"\xb7\x01\n\x0e\x43ommandMessage\x12\x17\n\x06header\x18\x01 \x02(\x0b\x32\x07.Header\x12\x0e\n\x04ping\x18\x03 \x01(\x08H\x00\x12\x11\n\x07message\x18\x04 \x01(\tH\x00\x12\x17\n\x03\x65rr\x18\x05 \x01(\x0b\x32\x08.FailureH\x00\x12!\n\x06reqMsg\x18\x06 \x01(\x0b\x32\x0f.RequestMessageH\x00\x12\"\n\x06resMsg\x18\x07 \x01(\x0b\x32\x10.ResponseMessageH\x00\x42\t\n\x07payloadB\x0b\n\x07routingH\x01')
  ,
  dependencies=[common_pb2.DESCRIPTOR,clientMessage_pb2.DESCRIPTOR,])
...
_COMMANDMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reqMsg', full_name='CommandMessage.reqMsg', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='resMsg', full_name='CommandMessage.resMsg', index=5,
...
_COMMANDMESSAGE.fields_by_name['reqMsg'].message_type = clientMessage_pb2._REQUESTMESSAGE
_COMMANDMESSAGE.fields_by_name['resMsg'].message_type = clientMessage_pb2._RESPONSEMESSAGE
...
_COMMANDMESSAGE.oneofs_by_name['payload'].fields.append(
  _COMMANDMESSAGE.fields_by_name['reqMsg'])
_COMMANDMESSAGE.fields_by_name['reqMsg'].containing_oneof = _COMMANDMESSAGE.oneofs_by_name['payload']
_COMMANDMESSAGE.oneofs_by_name['payload'].fields.append(
  _COMMANDMESSAGE.fields_by_name['resMsg'])
_COMMANDMESSAGE.fields_by_name['resMsg'].containing_oneof = _COMMANDMESSAGE.oneofs_by_name['payload']
